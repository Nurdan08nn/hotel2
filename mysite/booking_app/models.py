...
class Review(models.Model):
    ...
    stars = models.IntegerField(max_length=16, choices=[(str(i), str(i)) for i in range(1, 6)], null=True, blank=True)
...
class Booking(models.Model):
    ...
    status_book = models.CharField(max_length=16, choices=STATUS_BOOK_CHOICES, default='подверждено')
